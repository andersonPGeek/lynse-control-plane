...
!`node "${CLAUDE_PROJECT_DIR}/.claude/hooks/lynse-cli.mjs" start "$0" "${CLAUDE_SESSION_ID}"`

Você está na etapa **Entender e planejar** da Operação Lynse.

1. Leia a User Story identificada acima e todos os arquivos aplicáveis em `SPEC/`.
